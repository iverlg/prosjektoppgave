...
def run_empire(name, tab_file_path, result_file_path, scenariogeneration, scenario_data_path,
	...
	model.areaMaxInstalledCap = Param(model.Node, default=0.0, mutable=True)
	...
	data.load(filename=tab_file_path + "/" + 'Generator_OffshoreAreaMaxCapacity.tab', param=model.areaMaxInstalledCap, format="table")
	...
	def prepSload_rule(model):
		...
		counter = 0
		f = open(result_file_path + '/AdjustedNegativeLoad_' + name + '.txt', 'w', encoding="utf-8-sig")
		for n in model.Node:
			for i in model.Period:
				nodeaverageload = 0
				for h in model.Operationalhour:
	...
	if windfarmNodes is not None:
		...
		# This rule restricts the combined floating + grounded capacity to surpass the area capacity (default based on 5 MW/km2) 
		def area_cap_rule(model, n, i):
			for n in model.windfarmNodes:
		...
		model.area_cap_rule = Constraint(model.Node, model.Period, rule=area_cap_rule)
	...
	f = open(result_file_path + "/" + 'results_objective.csv', 'w', newline='', encoding="utf-8-sig")
	writer = csv.writer(f)
	...
	print("{hour}:{minute}:{second}: Writing transmission investment decisions to results_output_transmission.csv...".format(
		hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
	f = open(result_file_path + "/" + 'results_output_transmission.csv', 'w', newline='', encoding="utf-8-sig")
	writer = csv.writer(f)
	...
	f = open(result_file_path + "/" + 'results_output_gen.csv', 'w', newline='', encoding="utf-8-sig")
	writer = csv.writer(f)
	...
	print("{hour}:{minute}:{second}: Writing storage investment decisions to results_output_stor.csv...".format(
		hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
	f = open(result_file_path + "/" + 'results_output_stor.csv', 'w', newline='', encoding="utf-8-sig")
	writer = csv.writer(f)
	...
	print("{hour}:{minute}:{second}: Writing transmission operational decisions to results_output_transmission_operational.csv...".format(
		hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
	f = open(result_file_path + "/" + 'results_output_transmission_operational.csv', 'w', newline='', encoding="utf-8-sig")
	writer = csv.writer(f)
	...
	f = open(result_file_path + "/" + 'results_power_balance.csv', 'w', newline='', encoding="utf-8-sig")
	writer = csv.writer(f)
	...
	print("{hour}:{minute}:{second}: Writing curtailed power to results_output_curtailed_prod.csv...".format(
		hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
	f = open(result_file_path + "/" + 'results_output_curtailed_prod.csv', 'w', newline='', encoding="utf-8-sig")
	writer = csv.writer(f)
	...
	print("{hour}:{minute}:{second}: Writing summary file to results_output_EuropeSummary.csv...".format(
		hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
	f = open(result_file_path + "/" + 'results_output_EuropeSummary.csv', 'w', newline='', encoding="utf-8-sig")
	if solver == 'Xpress':
	...
	print("{hour}:{minute}:{second}: Writing operational results to results_output_Operational.csv...".format(
		hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
	f = open(result_file_path + "/" + 'results_output_Operational.csv', 'w', newline='', encoding="utf-8-sig")
	writer = csv.writer(f)
	...
	if hydrogen is True:
		print("{hour}:{minute}:{second}: Writing hydrogen investment results to results_hydrogen_production_investments.csv...".format(
			hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
		f = open(result_file_path + "/" + 'results_hydrogen_production_investments.csv', 'w', newline='', encoding="utf-8-sig")
		if solver == 'Xpress':
		...
		if h2storage is True:
			print("{hour}:{minute}:{second}: Writing hydrogen storage investment results to results_hydrogen_storage_investments.csv...".format(
				hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
			f = open(result_file_path + "/" + 'results_hydrogen_storage_investments.csv', 'w', newline='', encoding="utf-8-sig")
			writer = csv.writer(f)
			...
			print("{hour}:{minute}:{second}: Writing hydrogen storage operational results to results_hydrogen_storage_operational.csv...".format(
				hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
			f = open(result_file_path + "/" + 'results_hydrogen_storage_operational.csv', 'w', newline='', encoding="utf-8-sig")
			writer = csv.writer(f)
		...
		print("{hour}:{minute}:{second}: Writing hydrogen production results to results_hydrogen_production.csv...".format(
			hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
		f = open(result_file_path + '/' + 'results_hydrogen_production.csv', 'w', newline='', encoding="utf-8-sig")
		writer = csv.writer(f)
		...
		print("{hour}:{minute}:{second}: Writing hydrogen sales results to results_hydrogen_use.csv...".format(
			hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
		f = open(result_file_path + '/' + 'results_hydrogen_use.csv', 'w', newline='', encoding="utf-8-sig")
		if solver == 'Xpress':
			fError = open(result_file_path + "/" + "errorLog.log",'a')
		writer = csv.writer(f)
		...
		print("{hour}:{minute}:{second}: Writing hydrogen pipeline investment results to results_hydrogen_pipeline_investments.csv...".format(
			hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
		f = open(result_file_path + '/' + 'results_hydrogen_pipeline_investments.csv', 'w', newline='', encoding="utf-8-sig")
		writer = csv.writer(f)
		...
		print(
			"{hour}:{minute}:{second}: Writing hydrogen pipeline operational results to results_hydrogen_pipeline_operational.csv...".format(
				hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
		f = open(result_file_path + '/' + 'results_hydrogen_pipeline_operational.csv', 'w', newline='', encoding="utf-8-sig")
		writer = csv.writer(f)
		...
		print("{hour}:{minute}:{second}: Writing hydrogen investments costs and NPV calculation to results_hydrogen_costs.csv...".format(
			hour=datetime.now().strftime("%H"), minute=datetime.now().strftime("%M"), second=datetime.now().strftime("%S")))
		f = open(result_file_path + '/' + 'results_hydrogen_costs.csv', 'w', newline='', encoding="utf-8-sig")
		writer = csv.writer(f)
	...
	f = open(result_file_path + "/" + 'time_usage.csv', 'w', newline='', encoding="utf-8-sig")
	timeFrmt = "%H:%M:%S"
	dateFrmt = "%d.%m.%Y"
	timeDeltaFrmt = "{H}:{M}:{S}"
	writer = csv.writer(f)
